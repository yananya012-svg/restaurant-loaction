...
predictForm.addEventListener('submit', async (e) => {
    ...
    resultContainer.innerHTML = `
        <div class="result-card loading">
            ...
            <p class="result-label">Processing your request...</p>
        </div>
    `;
    ...
    try {
        ...
        if (response.ok) {
            resultContainer.innerHTML = `
                <div class="result-card success">
                    ...
                    <div class="result-value">₹${result.predicted_price.toLocaleString('en-IN')}</div>
                </div>
            `;
        } else {
            resultContainer.innerHTML = `
                <div class="result-card error">
                    ...
                    <p class="result-text">${result.detail || 'An error occurred'}</p>
                </div>
            `;
        }
    } catch (error) {
        resultContainer.innerHTML = `
            <div class="result-card error">
                ...
                <p class="result-text">Error: ${error.message}</p>
            </div>
        `;
    } finally {
